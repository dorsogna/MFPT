...
o.d = 2; % spatial dimension
o.z = 1; % radial (z=1) or tangential (z= -1).
o.pm = 0; % outward (+1) or inward motion (-1)

o.int_tol = 1e-12;

x = linspace(o.rho,o.R0,500);
...
for i = [1 2 3 4 5 6]
    ...
    elseif i==1
        o.pm =-1; 
        do_SSA =1;
        o.sigma = 0.06; o.mu = 0.1; lambda = 50;
        o.kap = @(r) r/lambda;     
   ...
   % o.F = @(r) exp( integral(@(s) ((o.d-1)./s).*( (1-o.z*o.alpha(s))./(1+o.z*o.alpha(s))) + o.pm*((o.z+1)/2)*o.d*o.mu*o.beta(s)/(o.sigma*(1+o.z*o.alpha(s)) ), o.rho,r) );
    ...
    title_str = '$\sigma = 0.06, \mu = 0.1$, $d=2$';
...
if (o.d==2)
    exportgraphics(figure(2),'MFPTQQ_radial_d=2.png','resolution',300);
end

if(o.d==3)
    exportgraphics(figure(2),'MFPTWW3_radial_d=3.png','resolution',300);
end
